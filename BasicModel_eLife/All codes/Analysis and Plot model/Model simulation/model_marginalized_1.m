...
dstep = 0.1;
paramsAll = [3.6612    5.5058    9.2363           0          40.8150     5.3367    0.2846    3.5999];
...
for kk=1:length(stdSensory)  
    ...
    imagesc(pthhAndth(indY, indX), 'AlphaData', ~isnan(pthhAndth(indY, indX)))
    hold on
    axis xy
    colorbar
