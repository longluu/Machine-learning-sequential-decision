...
params.barAngleDiff = [-15   -12    -9    -6    -3     0     3     6     9    12    15]; % the angle difference (degree)
...
params.sweepAngle = 0;%max(params.barAngleDiff);
...
fileLoad = 'ControlReplication-4';
Experiment_DriverPTB_ControlRep_Line(params, fileLoad)
