function [fitParameter, negLogLH] = modelFitBayes_New(optimizationAlgorithm, SetStartPoint, initialValue, fileID, expNumber, plotFitProgress, modelType, dataName, fixMotorNoise, includeIncongruentTrials, fixLapseRate)
...
if SetStartPoint
    ...
    priorRangeInitial = initialValue(5) + 8*(rand-0.5);
...
try
    ...
    fprintf(fileID,'%2s %9.1f %8.1f %9.1f %9.4f %9.4f %9.4f %16.4f  %10.4f %10.4f %8.4f %9.4f \r\n', '//', errorTotal, -logLikelihoodDiscriminate,...
