function [binaryDecision, percentCW, nTrialsPerCondition, angleDiffEstimate, angleDiff, stdMotor] = dataForFittingNew(subjectID, includeIncongruentTrials, correctIndex)
