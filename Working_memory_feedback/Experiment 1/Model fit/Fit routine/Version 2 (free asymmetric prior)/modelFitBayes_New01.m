function [fitParameter, negLogLH] = modelFitBayes_New01(optimizationAlgorithm, SetStartPoint, initialValue, fileID, expNumber, plotFitProgress, modelType, dataName, fixMotorNoise, includeIncongruentTrials, fixLapseRate, fixSmoothPrior, fixPcw)
...
b_Inequality = [0; 0];
vlb = [minStd minStd  0            10  -60 minStdMemory  minStdMotor  0               minPcw];
