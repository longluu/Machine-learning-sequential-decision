...
incorrectType = 4; % 1: flip the decision bit
                   ...
                   % 8: resample m, centered on m, variance: sensory+memory, No rejection
                   
dstep = 0.1;
paramsAll = [5.2200   9.5650            0          48.1703     0.0548   0.9768    3.3234];
