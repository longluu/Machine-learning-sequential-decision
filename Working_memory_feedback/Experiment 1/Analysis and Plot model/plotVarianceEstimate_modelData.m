%%%%%%%%%%%%%%%%%%%%%%% Compute the Std of estimates of the models %%%%%%%%%%%%%%%%%%%%%%
...
for nn = 1 : length(subjectIDAll)
    ...
    for kk=1:length(stdSensory)  
        ...
        estimate_Variance(nn, kk, :) = std_thhGthChccw(thetaStim >= 0);       
        ...
        estimate_FlipDecision(nn, kk, :) = std_thhGthChccw(thetaStim >= 0);        
        ...
        estimate_FlipDecision_addMemory(nn, kk, :) = std_thhGthChccw(thetaStim >= 0);  
        ...
        estimate_Resample(nn, kk, :) = std_thhGthChccw(thetaStim >= 0);        
        ...
        estimate_Surprise(nn, kk, :) = std_thhGthChccw(thetaStim >= 0); 
    end
end
