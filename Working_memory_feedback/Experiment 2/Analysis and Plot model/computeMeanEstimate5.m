...
estimateCW_FlipEstimate = NaN(length(subjectIDAll), 2);
estimateCCW_FlipEstimate = NaN(length(subjectIDAll), 2);
estimateCW_FlipDecision = NaN(length(subjectIDAll), 2);
estimateCCW_FlipDecision = NaN(length(subjectIDAll), 2);
estimateCW_2a2 = NaN(length(subjectIDAll), 2);
estimateCCW_2a2 = NaN(length(subjectIDAll), 2);
estimateCW_2b1 = NaN(length(subjectIDAll), 2);
estimateCCW_2b1 = NaN(length(subjectIDAll), 2);
...
%     ciCCW_Data(nn, 2, :) = bootci(1000, @nanmedian, abs(angleDiffEst(dataAll(:, 4) == stdNoiseLevel(2) & binaryFeedbackAll == -1)));
    ...
    for kk=1:length(stdSensory)  
        ...
        estimateCCW_FlipEstimate(nn, kk) = abs(meanCW * weightCW');
        estimateCW_FlipEstimate(nn, kk) = meanCCW * weightCCW';
        ...
        estimateCCW_2a2(nn, kk) = abs(meanCW * weightCW');
        estimateCW_2a2(nn, kk) = meanCCW * weightCCW';
        ...
        estimateCCW_2b1(nn, kk) = abs(meanCW * weightCW');
        estimateCW_2b1(nn, kk) = meanCCW * weightCCW';
...
set(gca, 'FontSize', 12)
for ii = 1 : length(subjectIDAll)
    plot(estimateCCW_2a2(ii, 1), estimateCW_2a2(ii, 1), 'o', 'Color', colorIndex(ii, :))
    plot(estimateCCW_2a2(ii, 2), estimateCW_2a2(ii, 2), 'x', 'Color', colorIndex(ii, :), 'MarkerSize', 10)
end
plot([minPlot maxPlot], [minPlot maxPlot], 'k--')
xlim([minPlot maxPlot])
ylim([minPlot maxPlot])
...
set(gca, 'FontSize', 12)
for ii = 1 : length(subjectIDAll)
    plot(estimateCCW_2b1(ii, 1), estimateCW_2b1(ii, 1), 'o', 'Color', colorIndex(ii, :))
    plot(estimateCCW_2b1(ii, 2), estimateCW_2b1(ii, 2), 'x', 'Color', colorIndex(ii, :), 'MarkerSize', 10)
end
plot([minPlot maxPlot], [minPlot maxPlot], 'k--')
xlim([minPlot maxPlot])
ylim([minPlot maxPlot])
...
estCCW_FlipEstimate = estimateCCW_FlipEstimate (:);
estCW_FlipEstimate  = estimateCW_FlipEstimate (:);
estFlipEstimate = [estCCW_FlipEstimate ; estCW_FlipEstimate ];
...
estCCW_2a2 = estimateCCW_2a2(:);
estCW_2a2 = estimateCW_2a2(:);
est2a2 = [estCCW_2a2; estCW_2a2];

estCCW_2b1 = estimateCCW_2b1(:);
estCW_2b1 = estimateCW_2b1(:);
est2b1 = [estCCW_2b1; estCW_2b1];
...
set(gca, 'FontSize', 12)
for ii = 1 : length(subjectIDAll)
    plot([estimateCCW_Data(ii, 1) estimateCW_Data(ii, 1)], [estimateCCW_FlipEstimate(ii, 1) estimateCW_FlipEstimate(ii, 1)], 'o', 'Color', colorIndex(ii, :))
    plot([estimateCCW_Data(ii, 2) estimateCW_Data(ii, 2)], [estimateCCW_FlipEstimate(ii, 2) estimateCW_FlipEstimate(ii, 2)], 'x', 'Color', colorIndex(ii, :), 'MarkerSize', 10)
end
plot([minPlot maxPlot], [minPlot maxPlot], 'k--')
xlim([minPlot maxPlot])
ylim([minPlot maxPlot])
...
r = round(corr(estData, estFlipEstimate, 'type', 'Pearson'), 2);
MSE = round(sum((estData - estFlipEstimate).^2) / length(estData), 1);
title (['1b, r: ' num2str(r) ', MSE: ' num2str(MSE)])
...
set(gca, 'FontSize', 12)
for ii = 1 : length(subjectIDAll)
    plot([estimateCCW_Data(ii, 1) estimateCW_Data(ii, 1)], [estimateCCW_2a2(ii, 1) estimateCW_2a2(ii, 1)], 'o', 'Color', colorIndex(ii, :))
    plot([estimateCCW_Data(ii, 2) estimateCW_Data(ii, 2)], [estimateCCW_2a2(ii, 2) estimateCW_2a2(ii, 2)], 'x', 'Color', colorIndex(ii, :), 'MarkerSize', 10)
end
plot([minPlot maxPlot], [minPlot maxPlot], 'k--')
xlim([minPlot maxPlot])
ylim([minPlot maxPlot])
xlabel('Mean estimate - data (deg)')
ylabel('Mean estimate - model (deg)')
r = round(corr(estData, est2a2, 'type', 'Pearson'), 2);
MSE = round(sum((estData - est2a2).^2) / length(estData), 1);
...
set(gca, 'FontSize', 12)
for ii = 1 : length(subjectIDAll)
    plot([estimateCCW_Data(ii, 1) estimateCW_Data(ii, 1)], [estimateCCW_2b1(ii, 1) estimateCW_2b1(ii, 1)], 'o', 'Color', colorIndex(ii, :))
    plot([estimateCCW_Data(ii, 2) estimateCW_Data(ii, 2)], [estimateCCW_2b1(ii, 2) estimateCW_2b1(ii, 2)], 'x', 'Color', colorIndex(ii, :), 'MarkerSize', 10)
end
plot([minPlot maxPlot], [minPlot maxPlot], 'k--')
xlim([minPlot maxPlot])
ylim([minPlot maxPlot])
xlabel('Mean estimate - data (deg)')
ylabel('Mean estimate - model (deg)')
r = round(corr(estData, est2b1, 'type', 'Pearson'), 2);
MSE = round(sum((estData - est2b1).^2) / length(estData), 1);
