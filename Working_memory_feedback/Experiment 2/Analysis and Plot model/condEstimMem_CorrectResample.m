...
incorrectType = 3; % 1: flip the estimates
                   ...
                   % 3: resample the measurement m until getting a consistent sample
                   % 4: lose all information and use prior to make estimate
                   % 5: resample m, centered on m, variance: memory
                   % 6: resample m, centered on m, variance: sensory+memory, No rejection
dstep = 0.1;
paramsAll = [6.2041    8.3568           0.0000     31.4168   -19.0927   5.4034    2.6349    0.9999    0.5358];
